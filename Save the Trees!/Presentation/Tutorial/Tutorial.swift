...
class TutorialViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Terceira mensagem
        let message3 = lightAttributedString(text: NSLocalizedString("Tap twice to make the ", comment: "Tap twice to make the "))
        message3.append(boldAttributedString(text: NSLocalizedString("fire or chainsaw", comment: "fire or chainsaw")))
        message3.append(lightAttributedString(text: NSLocalizedString(" disappear", comment: " disappear")))
